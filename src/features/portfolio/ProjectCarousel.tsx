  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden border border-border bg-card">
      ...
      <div className="flex flex-1 flex-col p-8">
        <p className="text-[10px] uppercase tracking-[0.25em] text-[#c69a6d]">{project.status}</p>
        ...
        <p className="mt-2 text-xs uppercase tracking-[0.18em] text-muted-foreground">
          {project.lotsAvailable > 0
            ? `${project.lotsAvailable} / ${project.lotsTotal} lotes disponíveis`
            : "Esgotado"}
        </p>
        <div className="mt-6 grid gap-4">
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Programa</p>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">{project.program}</p>
          </div>
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Demanda</p>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">{project.demand}</p>
          </div>
        </div>
      </div>
    </article>
